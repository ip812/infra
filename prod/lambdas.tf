...
resource "aws_lambda_function" "hello_function" {
  function_name = "hello"
  timeout       = 5
  image_uri     = "678468774710.dkr.ecr.eu-central-1.amazonaws.com/ip812/hello:89.1.0"
  package_type  = "Image"
...
resource "aws_lambda_function" "ecr_push_notifier_function" {
  ...
  timeout       = 60
  image_uri     = "678468774710.dkr.ecr.eu-central-1.amazonaws.com/ip812/ecr-push-notifier:0.4.0"
  package_type  = "Image"
